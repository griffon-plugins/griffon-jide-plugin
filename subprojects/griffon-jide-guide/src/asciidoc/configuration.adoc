...
----
dependencies {
    griffon '{project-group}:griffon-jide-plugin:{project-version}'
}
----
...
----
dependencies {
    compile 'com.jidesoft:jide-oss:{jide-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-jide-swing-groovy:{project-version}'
}
----
